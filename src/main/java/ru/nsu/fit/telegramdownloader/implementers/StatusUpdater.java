...
public class StatusUpdater {
    private static final long FILE_LIMIT = 50 * 1024 * 1024L;
    ...
    protected void uploadSplitFiles(String filename) throws IOException, TelegramApiException {
        try (RandomAccessFile raf = new RandomAccessFile(filename, "r")) {
            ...
            for(int destIx = 1; destIx <= numSplits; destIx++) {
                ...
                bw.close();
                uploadOneFile(filename + "_" + destIx);
    ...
    protected void uploadOneFile(String filename) throws TelegramApiException {
